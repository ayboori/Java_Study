...
public class Ayoung {
    public static void main(String[] args) {
        public static void main(String[] args) {
            ...
            System.out.println(ay.solution(5,new int[ ] {9, 20, 28, 18, 11}, new int[ ] {30, 1, 21, 17, 28}));
            // return ["#####", "# # #", "### #", "#  ##", "#####"]
            System.out.println(ay.solution(6, new int[ ] {46, 33, 33, 22, 31, 50},new int[ ] {27, 56, 19, 14, 14, 10}));
            // return ["######", "###  #", "##  ##", " #### ", " #####", "### # "]
        }
    }
