...
/*
테스트 통과 시간: 0.08ms ~ 1.11ms
| 테스트 1 〉 | 통과 (0.10ms, 84.4MB) |
| 테스트 2 〉 | 통과 (0.09ms, 77.9MB) |
| 테스트 3 〉 | 통과 (0.09ms, 71.9MB) |
| 테스트 4 〉 | 통과 (0.08ms, 71.9MB) |
| 테스트 5 〉 | 통과 (0.10ms, 78.7MB) |
| 테스트 6 〉 | 통과 (0.55ms, 73.2MB) |
| 테스트 7 〉 | 통과 (1.11ms, 76.9MB) |
| 테스트 8 〉 | 통과 (1.09ms, 74.8MB) |
| 테스트 9 〉 | 통과 (0.52ms, 76MB) |
 */