...
public class Jisoo2558 {
    public static void main( String[] args ) {
        ...
        /*
           ...
           근데 이 인풋스트림과 아웃풋스트림은 1byte값(1~255까지의 숫자 정도, 8bit라서, 2의 8승만큼)만 받아올 수 있다.
           바이트 기반 스트림.이라고 한다. byte[] 을 사용한다.

           Reader와 Writer는 문자 기반 스트림이다. 1 char단위로 받는다. char[] 배열을 사용한다.
           char[2]로 정해놓았으면 123을 입력해도 12까지만 들어가고
           첫번째 값은 1, 두번째 값은 2가 된다.
           배열이라 크기가 정해져 있다..!
           ...
           입출력에 관해서는 자바의 정석 ch.15에 자세히 나와있으며,
           나중에 좀 더 자세히 다뤄보도록 합시다!
